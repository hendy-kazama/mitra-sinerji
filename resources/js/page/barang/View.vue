    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                <router-link :to="{ name: 'barang.add' }" class="btn btn-primary mb-2 btn-md">Tambah</router-link>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr v-for="(row,i) in data" :key="i">
                                ...
                                <td>{{row.harga}} </td>
                                <td>
                                    <router-link :to="{ name: 'barang.edit', params: {id: row.id} }" class="btn btn-info btn-sm">Edit</router-link> &nbsp;
